        ...
        <main class="main">
            ...
            <div class="breadcrumbs">
                <div class="container">
                    ...
                    <span class="child"> <a href="about.php"> About </a> </span>
                    <i class="fa fa-chevron-right"></i>
                    ...
                    <div class="col-md-9 about-content">
                        ...
                        <section class="about-innovations">
                            <div class="section-title text-center">
                                <h2 class="title-services-other title-2"> INNOVATIONS </h2>
                        ...
                        <section class="about-company">
                            ...
                            <div class="com">
                                <h2 class="company-title color-title">INNOVATION </h2>
                        ...
                        <section class="about-culture">
                            <div class="row culture">
                                ...
                                <div class="col-sm-6 culture-video">
                                    <a href="#" class="hover-effect"> <img src="images/emp.jpg" /> </a>
                                </div>
                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Petrolium Engineering</a>
                                            </h4>
                                        </div>
                    ...
                    <div class="col-md-3 sidebar left">
                        ...
                        <div class="sidebar-blog-categories">
                            <ul>
                                ...
                                <li> <a href="leaders.php"> Our Leaders </a> </li>
                            </ul>
                        </div>
